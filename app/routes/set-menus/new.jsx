    ...
    <Form method="post">
      ...
      <Flex>
        <FormLabel htmlFor="recipe7Quantity">
          ...
          <Input type="number" id="recipe7Quantity" name="recipe7Quantity" />
        </FormLabel>
        <FormLabel>
          레시피7
      ...
      <Flex>
        <FormLabel htmlFor="recipe8Quantity">
          ...
          <Input type="number" id="recipe8Quantity" name="recipe8Quantity" />
        </FormLabel>
        <FormLabel>
          레시피8
      ...
      <Flex>
        <FormLabel htmlFor="recipe9Quantity">
          ...
          <Input type="number" id="recipe9Quantity" name="recipe9Quantity" />
        </FormLabel>
        <FormLabel>
          레시피9
